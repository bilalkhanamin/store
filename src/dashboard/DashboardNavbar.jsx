      ...
      <div className="bg-gray-200 h-full w-full">
        <nav>
          <div className="py-4 px-6 w-full flex xl:hidden justify-between items-center bg-white fixed top-0 z-40">
            ...
            <div className="flex items-center">
              <div className="relative mr-6 flex">
                ...
                <Link to="/">
                  <button className="focus:outline-none flex justify-between w-full relative ml-3 bg-gray-100 border-gray-300 border transition duration-150 ease-in-out hover:bg-gray-300 rounded text-gray-600 px-5 py-2 text-xs">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4"
                      fill="none"
                ...
                <Link to="/store">
                  <button className="focus:outline-none  flex justify-between   relative ml-5 bg-gray-100 border-gray-300 border transition duration-150 ease-in-out hover:bg-gray-300 rounded text-gray-600 px-5 py-2 text-xs">
                      store
                  </button>
                </Link>
              </div>
          ...
          <div
            className={
              show
                ? "w-full  h-full top-0 absolute z-40  transform  translate-x-0 "
                      ...
                      <a className="cursor-pointer">
                        <li className="text-gray-800 pt-10">
                          <div className="flex items-center">
                            ...
                            <Link
                              to="/dashboard/stats"
                              className="text-gray-800 xl:text-base text-base ml-3"
                            >
                              Dashboard
                            </Link>
                          </div>
